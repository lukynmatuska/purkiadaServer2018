...
class HtmlPage():
    ...
    def save(self):#WIP
        ...
        while True:
            #try:
            self.f2 = open("C:\\xampp\\htdocs\\purkiadaServer2018\\{0}.html".format(self.htmlFileName), "w")
            self.f2.write(str(self.update()))
            self.f2.close()
            print("FILE NAME: C:\\xampp\\htdocs\\purkiadaServer2018\\{0}.html".format(self.htmlFileName))
            break
            #except:
